...
const CAMPOS = ['nome','nascimento','whatsapp','email','endereco','turma','emergencia_nome','emergencia_fone','saude','cobranca_nome','cobranca_email','cobranca_whatsapp'];
...
export async function onRequestPost(context) {
  ...
  await db.prepare(
    'INSERT INTO alunos (criado, status, nome, nascimento, whatsapp, email, endereco, turma, emergencia_nome, emergencia_fone, saude, cobranca_nome, cobranca_email, cobranca_whatsapp) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)'
  ).bind(
    new Date().toISOString(), 'novo',
    d.nome, d.nascimento, d.whatsapp, d.email, d.endereco, d.turma,
